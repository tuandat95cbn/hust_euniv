...
public class mAcademicRank implements Serializable{
	...
	private Set<mStaff> listStaffs = new HashSet<mStaff>();
	...
	public Set<mStaff> getListStaffs() {
		return listStaffs;
	}
	public void setListStaffs(Set<mStaff> listStaffs) {
