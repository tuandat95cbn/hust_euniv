...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Kết xuất tổng hợp mẫu ISI 02</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form:form action="${baseUrl}/cp/summaryExcelISI02" method="POST" commandName="summaryExcelFormISI02" role="form">
	                    <div class="row">
	                        <div class="col-lg-6">
...
$(document).ready(function() {
    $('.generate').click(function(){
    	window.location = baseUrl+"/cp/summaryExcelISI02";
    });
