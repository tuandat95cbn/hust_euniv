...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Kết xuất tổng hợp mẫu 01 KV</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form:form action="${baseUrl}/cp/summaryExcelKV01" method="POST" commandName="summaryExcelFormKV01" role="form">
	                    <div class="row">
	                        <div class="col-lg-6">
...
$(document).ready(function() {
    $('.generate').click(function(){
    	window.location = baseUrl+"/cp/summaryExcelKV01";
    });
