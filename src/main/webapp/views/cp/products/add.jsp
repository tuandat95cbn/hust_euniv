...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Đăng ký chuyên đề</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form:form action="${baseUrl}/cp/save-a-product.html" method="POST" commandName="productFormAdd" role="form" enctype="multipart/form-data">
	                    <div class="row">
	                        <div class="col-lg-6">
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <form:input path="productName" class="form-control" name="productName" placeholder="Project Name"></form:input>
                                	...
                                	<div class="form-group">
	                                    ...
	                                    <form:input path="productBudget" class="form-control" name="productBudget" placeholder="Budget"></form:input>
	    								<form:errors path="productBudget" class="alert-danger"></form:errors>
                                	</div>
	                                <button type="submit" class="btn btn-primary" id="addANewProduct">Lưu</button>
	                        ...
	                        <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <form:input path="productStartDate" class="form-control year" name="productStartDate" readonly="true" placeholder="Start date"></form:input>
                                ...
                                <div class="form-group">
                                    ...
                                    <form:input path="productEndDate" class="form-control year" name="productEndDate" readonly="true" placeholder="End date"></form:input>
