...
<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Danh sách đề tài đã đăng ký</h1>
			<p>
	...
	var o_Settings = {
	        ...
	        "aoColumns": [
	            ...
	            { "mData": "id", "sWidth": "50px", "bSortable": false, 'mRender': function(resObj) {
	                	...
	                	res += '<button type="button" onclick="v_fViewDetailAThreadToApprove('+resObj+');" class="btn btn-info btn-xs" title="Edit">Phê duyệt</button><br>';
	                	return res;
	              } },
	        ],
...
function v_fViewDetailAThreadToApprove(iThreadId){
	var sViewDetailUrl = baseUrl + "/cp/threadshowtoapprove/"+iThreadId+".html";
	window.location = sViewDetailUrl;
}
