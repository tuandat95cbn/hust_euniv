		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div>
						<form:form action="${baseUrl}/cp/threadsExcell" method="POST" commandName="threadExcellForm" role="form">
							<div class="form-group input-group">
								<form:select class="form-control" style="width:200px;" path="threadCatCode">
									<option value="" >Chọn nhóm</option>
		                        	<c:forEach items="${threadCategory}" var="threadCat">
	                                 	<option value="${threadCat.PROJCAT_Code}">${threadCat.PROJCAT_Name}</option>
	                               	</c:forEach>
		                        </form:select>
		                        <form:select class="form-control" style="width:200px;" path="threadStatus">
		                        ...
		                        <form:select class="form-control" style="width:200px;" path="threadFaculty" onchange="showDepartment(this);">
