	                    ...
	                    <div class="row">
	                        <div class="col-lg-12">
	                        	<div class="form-group">
			                        ...
			                        <select class="form-control" name="PROJCALL_CODE" data-validation="required" data-validation-error-msg="Trường thông tin này là bắt buộc" onchange="showProjectsOfThisCall(this); showStaffsOfThisCall(this);">
