...
<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Sinh mã cho đề tài</h1>
			<p>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">Sinh mã cho đề tài</div>
				<!-- /.panel-heading -->
				<div class="panel-body">
					<form:form action="${baseUrl}/cp/generate-project-code.html" method="POST" id="formSubmit" commandName="threadExcellForm" role="form">
					<div class="row">
                       <div class="col-lg-6">
                       	<div class="panel panel-default">
