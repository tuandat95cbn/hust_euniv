...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Thêm mới bài báo</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    <form:form action="${baseUrl}/cp/save-a-paper.html" method="POST" commandName="paperFormAdd" role="form" enctype="multipart/form-data">
    <div class="row">
        <div class="col-lg-12">
	                    ...
	                    <div class="row">
	                        <div class="col-lg-6">
	                                <div class="form-group">
	                                    <label>Nhóm*</label>
	                                    <form:select path="paperCatCode" class="form-control" data-validation="required" data-validation-error-msg="Trường thông tin này là bắt buộc"  name="paperCatCode" onchange="v_fChangeCategory();">
	                                    	<c:forEach items="${paperCategory}" var="paperCat">
		                                        <option value="${paperCat.PCAT_Code}">${paperCat.PCAT_Name}</option>
	                                       	</c:forEach>
	                                    </form:select>
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <form:input path="paperPubName" class="form-control" data-validation="required" data-validation-error-msg="Trường thông tin này là bắt buộc"  name="paperPubName" placeholder="Pubication Name"></form:input>
	    								<form:errors path="paperPubName" class="alert-danger"></form:errors>
	                                </div>
	                                <div class="form-group">
	                                    <label for="paperJConfName">Tên tạp chí*</label>
	                                    <form:input path="paperJConfName" class="form-control" data-validation="required" data-validation-error-msg="Trường thông tin này là bắt buộc"  name="paperJConfName" placeholder="Journal Conference Name"></form:input>
	    								<form:errors path="paperJConfName" class="alert-danger"></form:errors>
	                                </div>
	                                <div class="form-group">
	                                    <label for="paperISSN">Chỉ số ISSN</label>
	                                    <form:input path="paperISSN" class="form-control" name="paperISSN" placeholder="ISSN"></form:input>
	    								<form:errors path="paperISSN" class="alert-danger"></form:errors>
	                                </div>
	                                <div class="form-group">
	                                	<label for="patentAuthors">Năm kê khai*</label>
		                                <form:select path="patentReportingAcademicDate" class="form-control" data-validation="required" data-validation-error-msg="Trường thông tin này là bắt buộc"  name="patentReportingAcademicDate" onchange="v_fChangeCategory();">
	                        ...
	                        <div class="col-lg-6">
	                        		<%-- <div class="form-group">
	                                    ...
	                                    <form:hidden path="paperAutConHours" class="form-control" name="paperAutConHours" disabled="disabled" placeholder="Author Converted Hours"></form:hidden>
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <form:input path="paperYear" class="form-control year" data-validation="required" data-validation-error-msg="Trường thông tin này là bắt buộc"  name="paperYear" readonly="true" placeholder="YYYY"></form:input>
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <form:input path="paperVolumn" class="form-control" name="paperVolumn" placeholder="Volumn"></form:input>
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <form:input path="paperAuthorList" class="form-control" name="paperAuthorList" placeholder="Authors"></form:input>
	                                ...
	                                <!-- <div class="form-group">
	                                    ...
	                                    <form:select path="paperJIndexCode" disabled="disabled" class="form-control" name="paperJIndexCode">
		                                    <c:forEach items="${journalList}" var="journal">
		                                        <option value="${journal.JNAL_IndexCode}">${journal.JNAL_IndexCode}</option>
	                                       	</c:forEach>
	                                    </form:select>
