...
<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Chỉnh sửa học viên</h1>
		</div>
		<!-- /.col-lg-12 -->
	</div>
	<!-- /.row -->
	<form:form id="form-add" action="${baseUrl}/mm/update-a-student.html" method="POST" commandName="studentFormAdd" role="form" accept-charset="UTF-8">
		<div class="row">
					...
					<div class='form'>
						<form:select path="studentClasses" class="form-control" name="studentClasses">
							<c:forEach items="${classesList}" var="classes">
	                       		<option <c:if test="${classes.classes_Code == studentClassCode}">selected</c:if> value="${classes.classes_Code}" >${classes.classes_Name}</option>
	                       	</c:forEach>
	                    </form:select>
		...
		<div class="row" style="padding-bottom:20px;">
			<div class="col-lg-4">
				<form:hidden path="studentId" name="topicId" value="${studentId}"/>
				<button type="submit" class='form btn btn-primary' id="save">Lưu</button>
