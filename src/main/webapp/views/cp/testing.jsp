...
<div id="page-wrapper">
	<div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Testing...<i style="color:green;">${indexHiearcyValue}</i> module</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <div class="row">
                            ...
                            <tbody>
                            	<c:forEach items="${listUsers}" var="user">
                            		<tr class="gradeX">
	                                    ...
	                                    <td class="center">
	                                    	<button type="button" onclick="v_fViewDetail();" class="btn btn-info btn-xs" title="Edit">Info</button>
	                                    	<br/>
											<button type="button" onclick="v_fRemoveAnUser();" class="btn btn-danger btn-xs" title="Remove">Remove</button>
	                                    </td>
                                	</tr>
								</c:forEach>
                            </tbody>
